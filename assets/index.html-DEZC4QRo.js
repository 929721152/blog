import { _ as h, c as l, a as e, b as a, w as n, d as i, r as p, o as k } from './app-B_7CxFr0.js'
const d = {}
function r(o, s) {
	const t = p('LinkCard')
	return (
...
<span class="line"><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE;">  - 这里是卡片内容</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">&lt;/</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375;">LinkCard</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">&gt;</span></span></code></pre></div><p><strong>输出：</strong></p>`,
					4
				)),
			a(
				t,
						...
						() =>
							...
							(s[0] = [
								i(
									'ul',
									null,
									[i('li', null, '这里是卡片内容'), i('li', null, '这里是卡片内容')],
									-1
								),
							])
					),
			...
			a(
				...
				{ href: '/' },
				{
					title: n(() => s[1] || (s[1] = [i('span', { style: { color: 'red' } }, '卡片标题', -1)])),
					default: n(() => [
						s[2] ||
							(s[2] = i(
								'ul',
			...
			s[5] ||
				(s[5] = i(
					...
					[
						i('p', { class: 'hint-container-title' }, '相关信息'),
						i(
							'p',
							null,
...
const c = h(d, [
	...
	y = JSON.parse(
		'{"path":"/blog/guide/components/link-card/","title":"链接卡片","lang":"zh-CN","frontmatter":{"title":"链接卡片","author":"pengzhanbo","icon":"solar:card-send-linear","createTime":"2024/08/18 23:14:00","permalink":"/blog/guide/components/link-card/","description":"概述 使用 <LinkCard> 组件在页面中显示链接卡片。 Props 插槽 示例 输入： 输出：","head":[["meta",{"property":"og:url","content":"https://plume.pengzhanbo.cn/blog/guide/components/link-card/"}],["meta",{"property":"og:site_name","content":"前端"}],["meta",{"property":"og:title","content":"链接卡片"}],["meta",{"property":"og:description","content":"概述 使用 <LinkCard> 组件在页面中显示链接卡片。 Props 插槽 示例 输入： 输出："}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-12-18T09:08:58.000Z"}],["meta",{"property":"article:author","content":"pengzhanbo"}],["meta",{"property":"article:modified_time","content":"2024-12-18T09:08:58.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"链接卡片\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-12-18T09:08:58.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"pengzhanbo\\"}]}"]]},"headers":[],"readingTime":{"minutes":1.18,"words":353},"git":{"updatedTime":1734512938000,"contributors":[{"name":"王亚坡","username":"王亚坡","email":"929721152@qq.com","commits":1,"avatar":"https://gravatar.com/avatar/6d7f6e036626c48bd70f6d964494f974b5a02c1fd139d7f4e7d75536f0cf60a0?d=retro"}],"changelog":[{"hash":"b291780c200a860e8b6acb86e50f9f124f17597f","date":1734512938000,"email":"929721152@qq.com","author":"王亚坡","message":"初始化提交","commitUrl":"https://github.com/pengzhanbo/vuepress-theme-plume/commit/b291780c200a860e8b6acb86e50f9f124f17597f"}]},"autoDesc":true,"filePathRelative":"notes/theme/blog/guide/组件/链接卡片.md","bulletin":false}'
	)
