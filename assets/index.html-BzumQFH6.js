...
function y(u, e) {
	...
	return (
		...
		p('div', null, [
			e[8] ||
				(e[8] = d(
					'<h2 id="概述" tabindex="-1"><a class="header-anchor" href="#概述"><span>概述</span></a></h2><p>主题通过 <code>&lt;Layout /&gt;</code> 和 <code>&lt;NotFound /&gt;</code> 提供了 丰富的 布局插槽，可以通过这些插槽，在 页面 的不同位置注入内容。 以便用户可以个性化的使用主题。</p><h2 id="使用" tabindex="-1"><a class="header-anchor" href="#使用"><span>使用</span></a></h2><p>以 <code>&lt;Layout /&gt;</code> 为例，首先，需要创建一个 客户端配置文件： <code>.vuepress/client.ts</code>:</p>',
					4
				)),
			n(
				k,
				{ id: '12', data: [{ id: '.vuepress/client.ts' }] },
				{
					title0: t(({ value: l, isActive: a }) => [
						n(h, { name: 'vscode-icons:file-type-typescript' }),
						e[0] || (e[0] = i('span', null, '.vuepress/client.ts', -1)),
					]),
					tab0: t(
						({ value: l, isActive: a }) =>
							e[1] ||
...
`),
			...
			e[9] ||
				(e[9] = d(
					'<div class="hint-container info"><p class="hint-container-title">相关信息</p><p><code>layouts</code> 中的 <code>Layout</code> 名是固定的，这是 js 的简写语法， 实际上为 <code>Layout: Layout</code>，它是实现 布局插槽的关键。 <code>NotFound</code> 也是相同的规则。</p><p>你传入的其它非 <code>Layout</code> / <code>NotFound</code> 的组件，被认为是自定义布局组件。</p></div><p>然后，创建一个 <code>.vuepress/layouts/Layout.vue</code>，作为布局插槽的默认组件，在该组件中引入 当前主题的 <code>&lt;Layout /&gt;</code> 组件。</p>',
					2
				)),
			n(
				k,
				{ id: '28', data: [{ id: '.vuepress/layouts/Layout.vue' }] },
				{
					title0: t(({ value: l, isActive: a }) => [
						n(h, { name: 'vscode-icons:file-type-vue' }),
						e[2] || (e[2] = i('span', null, '.vuepress/layouts/Layout.vue', -1)),
					]),
					tab0: t(
						({ value: l, isActive: a }) =>
							e[3] ||
...
`),
			...
			e[10] ||
				(e[10] = i(
					...
					null,
					[
						s('也可以使用 渲染函数 实现注入内容，在 '),
						i('code', null, '.vuepress/client.ts'),
						s(' 中：'),
					],
					-1
				)),
			n(
				...
				{
					id: '36',
					data: [{ id: '.vuepress/client.ts' }, { id: '.vuepress/components/CustomContent.vue' }],
				},
				{
					title0: t(({ value: l, isActive: a }) => [
						n(h, { name: 'vscode-icons:file-type-typescript' }),
						e[4] || (e[4] = i('span', null, '.vuepress/client.ts', -1)),
					]),
					title1: t(({ value: l, isActive: a }) => [
						n(h, { name: 'vscode-icons:file-type-vue' }),
						e[5] || (e[5] = i('span', null, '.vuepress/components/CustomContent.vue', -1)),
					]),
					tab0: t(
						({ value: l, isActive: a }) =>
							e[6] ||
					...
					tab1: t(
						({ value: l, isActive: a }) =>
							...
							(e[7] = [
								i(
									'div',
									{ class: 'language-vue', 'data-ext': 'vue', 'data-title': 'vue' },
									[
										i('button', { class: 'copy', title: '复制代码', 'data-copied': '已复制' }),
										i('pre', { class: 'shiki shiki-themes vitesse-light vitesse-dark vp-code' }, [
											i('code', null, [
...
const v = r(g, [
	...
	b = JSON.parse(
		'{"path":"/blog/guide/layout-slots/","title":"布局插槽","lang":"zh-CN","frontmatter":{"title":"布局插槽","icon":"ph:layout-duotone","author":"Plume Theme","createTime":"2024/06/17 16:19:43","permalink":"/blog/guide/layout-slots/","description":"概述 主题通过 <Layout /> 和 <NotFound /> 提供了 丰富的 布局插槽，可以通过这些插槽，在 页面 的不同位置注入内容。 以便用户可以个性化的使用主题。 使用 以 <Layout /> 为例，首先，需要创建一个 客户端配置文件： .vuepress/client.ts: 相关信息 layouts 中的 Layout 名是固定的，这...","head":[["meta",{"property":"og:url","content":"https://plume.pengzhanbo.cn/blog/guide/layout-slots/"}],["meta",{"property":"og:site_name","content":"前端"}],["meta",{"property":"og:title","content":"布局插槽"}],["meta",{"property":"og:description","content":"概述 主题通过 <Layout /> 和 <NotFound /> 提供了 丰富的 布局插槽，可以通过这些插槽，在 页面 的不同位置注入内容。 以便用户可以个性化的使用主题。 使用 以 <Layout /> 为例，首先，需要创建一个 客户端配置文件： .vuepress/client.ts: 相关信息 layouts 中的 Layout 名是固定的，这..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-12-18T09:08:58.000Z"}],["meta",{"property":"article:author","content":"Plume Theme"}],["meta",{"property":"article:modified_time","content":"2024-12-18T09:08:58.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"布局插槽\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-12-18T09:08:58.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Plume Theme\\"}]}"]]},"headers":[],"readingTime":{"minutes":1.79,"words":536},"git":{"updatedTime":1734512938000,"contributors":[{"name":"王亚坡","username":"王亚坡","email":"929721152@qq.com","commits":1,"avatar":"https://gravatar.com/avatar/6d7f6e036626c48bd70f6d964494f974b5a02c1fd139d7f4e7d75536f0cf60a0?d=retro"}],"changelog":[{"hash":"b291780c200a860e8b6acb86e50f9f124f17597f","date":1734512938000,"email":"929721152@qq.com","author":"王亚坡","message":"初始化提交","commitUrl":"https://github.com/pengzhanbo/vuepress-theme-plume/commit/b291780c200a860e8b6acb86e50f9f124f17597f"}]},"autoDesc":true,"filePathRelative":"notes/theme/blog/guide/布局插槽.md","bulletin":false}'
	)
