...
`),
			...
			a[21] ||
				(a[21] = p(
					`<div class="language-ts line-numbers-mode" data-ext="ts" data-title="ts"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code><span class="line"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676;">interface</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994;"> BulletinOptions</span><span style="--shiki-light:#999999;--shiki-dark:#666666;"> {</span></span>
...
`),
			...
			a[22] ||
				(a[22] = s(
					...
					[
						i('还可以声明 '),
						s('code', null, 'bulletin.contentType'),
						i(' 为 '),
...
`),
			...
			a[23] ||
				(a[23] = s(
					...
					{ id: '长内容公告', tabindex: '-1' },
					[
						s('a', { class: 'header-anchor', href: '#长内容公告' }, [
							s('span', null, '长内容公告'),
						]),
					],
					-1
			...
			a[24] ||
				(a[24] = s(
					...
					[
						i(
							'当您需要配置 长内容的公告板时，将长内容写在配置文件中会显得比较臃肿和难以阅读， 这时候可以使用 '
						),
						s('code', null, 'bulletin.contentFile'),
						i(' 添加内容文件路径，将长内容与配置文件分开。'),
					],
					-1
				)),
			a[25] ||
				(a[25] = s(
					...
					[
						...
						i(' 或 '),
						s('code', null, 'html'),
						i(' 文件的绝对路径。主题将使用该文件内容作为公告内容。'),
					],
					-1
				)),
			t(
				k,
				{ id: '52', data: [{ id: '.vuepress/config.ts' }, { id: '.vuepress/_bulletin.md' }] },
				{
					title0: l(({ value: n, isActive: e }) => [
						t(h, { name: 'vscode-icons:file-type-typescript' }),
						a[6] || (a[6] = s('span', null, '.vuepress/config.ts', -1)),
					]),
					title1: l(({ value: n, isActive: e }) => [
						t(h, { name: 'vscode-icons:file-type-markdown' }),
						a[7] || (a[7] = s('span', null, '.vuepress/_bulletin.md', -1)),
					]),
					tab0: l(
						({ value: n, isActive: e }) =>
							a[8] ||
...
`),
												s('span', { class: 'line' }, [
													s(
														'span',
														{ style: { '--shiki-light': '#A65E2B', '--shiki-dark': '#D4976C' } },
														'-'
													),
													s(
														'span',
...
`),
			...
			a[26] ||
				(a[26] = p(
					'<p>主题会监听 <code>bulletin.contentFile</code> 的变化，当文件内容发生变化时，会重新渲染公告板。</p><h2 id="自定义内容交互公告" tabindex="-1"><a class="header-anchor" href="#自定义内容交互公告"><span>自定义内容交互公告</span></a></h2><p>使用 <code>bulletin.content</code> 或 <code>bulletin.contentFile</code> 仅能编写纯文本的公告内容，以及通过 <code>markdown</code> 语法 支持的一些交互内容。无法编写一个带有其他的自定义交互的公告内容。</p><p>对于此类场景，主题也提供了相应的支持。</p><p>首先，配置 <code>bulletin</code> 的基础内容，此时您无需再配置 <code>bulletin.content</code> 或 <code>bulletin.contentFile</code> 。</p>',
					5
				)),
			t(
				k,
				{ id: '75', data: [{ id: '.vuepress/config.ts' }] },
				{
					title0: l(({ value: n, isActive: e }) => [
						t(h, { name: 'vscode-icons:file-type-typescript' }),
						a[10] || (a[10] = s('span', null, '.vuepress/config.ts', -1)),
					]),
					tab0: l(
						({ value: n, isActive: e }) =>
							a[11] ||
			...
			a[27] ||
				(a[27] = s(
					...
					[
						...
						i(' 中注册全局组件 '),
						s('code', null, 'BulletinContent'),
						i(' ，主题将会自动检索该组件并作为公告板的内容。'),
					],
					-1
				)),
			t(
				k,
				{ id: '83', data: [{ id: '.vuepress/client.ts' }] },
				{
					title0: l(({ value: n, isActive: e }) => [
						t(h, { name: 'vscode-icons:file-type-typescript' }),
						a[12] || (a[12] = s('span', null, '.vuepress/client.ts', -1)),
					]),
					tab0: l(
						({ value: n, isActive: e }) =>
							a[13] ||
...
`),
												s('span', { class: 'line' }, [
													...
													s(
														'span',
														{ style: { '--shiki-light': '#B56959', '--shiki-dark': '#C98A7D' } },
														'./components/BulletinContent.vue'
													),
													s(
														'span',
														{
...
`),
			...
			a[28] ||
				(a[28] = s(
					'p',
					null,
					[i('接下来，编写 '), s('code', null, 'BulletinContent.vue'), i(' 组件')],
					-1
				)),
			t(
				k,
				{ id: '91', data: [{ id: '.vuepress/components/BulletinContent.vue' }] },
				{
					title0: l(({ value: n, isActive: e }) => [
						t(h, { name: 'vscode-icons:file-type-vue' }),
						a[14] || (a[14] = s('span', null, '.vuepress/components/BulletinContent.vue', -1)),
					]),
					tab0: l(
						({ value: n, isActive: e }) =>
							a[15] ||
...
`),
			...
			a[29] ||
				(a[29] = p(
					`<h2 id="自定义公告板样式" tabindex="-1"><a class="header-anchor" href="#自定义公告板样式"><span>自定义公告板样式</span></a></h2><p>您可以直接通过 css 覆盖公告板的样式。</p><p>通过修改以下 css 变量，可方便的控制公告板的样式。</p><div class="language-css line-numbers-mode" data-ext="css" data-title="css"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code><span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">:</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;">root</span><span style="--shiki-light:#999999;--shiki-dark:#666666;"> {</span></span>
...
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>或者通过 <code>.vp-bulletin</code> 全局样式覆盖公告板的样式。</p><div class="language-css" data-ext="css" data-title="css"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code><span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">.</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;">vp-bulletin</span><span style="--shiki-light:#999999;--shiki-dark:#666666;"> {</span></span>
<span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD;">  /* 公告板样式 */</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">}</span></span></code></pre></div><h2 id="完全自定义公告板" tabindex="-1"><a class="header-anchor" href="#完全自定义公告板"><span>完全自定义公告板</span></a></h2><p>当您完全不想使用主题内置的公告板时，可以通过注册全局组件 <code>Bulletin</code> 来完全自定义公告板。</p>`,
					8
				)),
			t(
				k,
				{ id: '116', data: [{ id: '.vuepress/client.ts' }] },
				{
					title0: l(({ value: n, isActive: e }) => [
						t(h, { name: 'vscode-icons:file-type-typescript' }),
						a[16] || (a[16] = s('span', null, '.vuepress/client.ts', -1)),
					]),
					tab0: l(
						({ value: n, isActive: e }) =>
							a[17] ||
...
`),
			...
			a[30] ||
				(a[30] = s(
					'p',
					null,
					[i('接下来，编写 '), s('code', null, 'Bulletin.vue'), i(' 组件')],
					-1
				)),
			t(
				k,
				{ id: '124', data: [{ id: '.vuepress/components/Bulletin.vue' }] },
				{
					title0: l(({ value: n, isActive: e }) => [
						t(h, { name: 'vscode-icons:file-type-vue' }),
						a[18] || (a[18] = s('span', null, '.vuepress/components/Bulletin.vue', -1)),
					]),
					tab0: l(
						({ value: n, isActive: e }) =>
							a[19] ||
...
`),
			...
			a[31] ||
				(a[31] = p(
					`<p>您需要重头开始编写公告板组件，为方便编写公告板，主题提供了 composable API <code>useBulletinControl()</code>， 您可以直接在 <code>Bulletin.vue</code> 组件中使用它。</p><div class="language-ts" data-ext="ts" data-title="ts"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code><span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375;">import</span><span style="--shiki-light:#999999;--shiki-dark:#666666;"> {</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;"> useBulletinControl</span><span style="--shiki-light:#999999;--shiki-dark:#666666;"> }</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375;"> from</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77;"> &#39;</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D;">vuepress-theme-plume/composables</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77;">&#39;</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">  })</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">})</span></span></code></pre></div><p>当你未显式配置 <code>bulletin.id</code> 时，主题会根据 <code>bulletin</code> 对象生成一个 hash 值作为唯一标识。</p><h3 id="公告持续时间" tabindex="-1"><a class="header-anchor" href="#公告持续时间"><span>公告持续时间</span></a></h3><p>公告板的持续时间由 <code>bulletin.lifetime</code> 配置。</p><ul><li><p><code>session</code> 表示在 当前会话周期内，如果用户没有关闭公告板，则会一直显示，这包括到下个会话周期。 而当用户关闭公告板，则表示公告板已过期，在当前会话周期内不再显示，但在下一个会话周期会重新显示。</p></li><li><p><code>always</code> 表示公告板即使被用户关闭，不仅下一个会话周期也会重新显示，刷新页面也会重新显示。</p></li><li><p><code>once</code> 表示公告板在当前会话周期内一旦被关闭，之后都不再显示。</p></li></ul><details class="hint-container details"><summary>什么是会话？</summary><p><strong>会话</strong> 表示当您访问某个站点时，在您停留在这个站点的时间内，只要站点所在的浏览器标签页没有被关闭， 那么这个站点就会保持为同一个会话，即使页面刷新也依然保持为同一个会话。</p></details><h3 id="公告板的位置" tabindex="-1"><a class="header-anchor" href="#公告板的位置"><span>公告板的位置</span></a></h3><p>公告板的位置由 <code>bulletin.layout</code> 配置。</p><ul><li><code>top-left</code>：顶部居左</li><li><code>top-right</code>：顶部居右</li><li><code>bottom-left</code>：底部居左</li><li><code>bottom-right</code>：底部居右</li><li><code>center</code>：顶部居中</li></ul><h3 id="公告板显示的页面" tabindex="-1"><a class="header-anchor" href="#公告板显示的页面"><span>公告板显示的页面</span></a></h3><p>公告板的显示页面由 <code>bulletin.enablePage</code> 配置。</p><ul><li><code>true</code> 表示所有页面</li><li><code>false</code> 表示不显示</li><li>传入一个函数，返回 <code>true</code> 时显示</li></ul><div class="language-ts line-numbers-mode" data-ext="ts" data-title="ts"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code><span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375;">export</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375;"> default</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665;"> defineUserConfig</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">({</span></span>
<span class="line"><span style="--shiki-light:#998418;--shiki-dark:#B8A965;">  theme</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">: </span><span style="--shiki-light:#59873A;--shiki-dark:#80A665;">plumeTheme</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">({</span></span>
<span class="line"><span style="--shiki-light:#998418;--shiki-dark:#B8A965;">    bulletin</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">: {</span></span>
<span class="line"><span style="--shiki-light:#998418;--shiki-dark:#B8A965;">      layout</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">: </span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77;">&#39;</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D;">top-right</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77;">&#39;</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">,</span></span>
<span class="line"><span style="--shiki-light:#998418;--shiki-dark:#B8A965;">      title</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">: </span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77;">&#39;</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D;">公告板标题</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77;">&#39;</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">,</span></span>
...
const u = r(c, [
	...
	v = JSON.parse(
		'{"path":"/blog/guide/features/bulletin/","title":"公告板","lang":"zh-CN","frontmatter":{"title":"公告板","icon":"mingcute:announcement-line","badge":{"type":"tip","text":"v1.0.0-rc.112 +"},"createTime":"2024/10/19 21:51:22","permalink":"/blog/guide/features/bulletin/","description":"概述 公告板是一个实时通知组件，可以实现在站点中方便的展示一些通知信息。 如右上角的公告板。 使用 主题提供了非常方便且灵活的 公告板 使用方法。你可以根据自己的需求，选择合适的方式进行配置。 配置说明 简单公告 当您仅需要配置 简单的公告板，仅包含一些简要的内容 时，可以直接使用 bulletin.content 添加内容。 还可以声明 bullet...","head":[["meta",{"property":"og:url","content":"https://plume.pengzhanbo.cn/blog/guide/features/bulletin/"}],["meta",{"property":"og:site_name","content":"前端"}],["meta",{"property":"og:title","content":"公告板"}],["meta",{"property":"og:description","content":"概述 公告板是一个实时通知组件，可以实现在站点中方便的展示一些通知信息。 如右上角的公告板。 使用 主题提供了非常方便且灵活的 公告板 使用方法。你可以根据自己的需求，选择合适的方式进行配置。 配置说明 简单公告 当您仅需要配置 简单的公告板，仅包含一些简要的内容 时，可以直接使用 bulletin.content 添加内容。 还可以声明 bullet..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-12-18T09:08:58.000Z"}],["meta",{"property":"article:modified_time","content":"2024-12-18T09:08:58.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"公告板\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-12-18T09:08:58.000Z\\",\\"author\\":[]}"]]},"headers":[],"readingTime":{"minutes":6.15,"words":1844},"git":{"updatedTime":1734512938000,"contributors":[{"name":"王亚坡","username":"王亚坡","email":"929721152@qq.com","commits":1,"avatar":"https://gravatar.com/avatar/6d7f6e036626c48bd70f6d964494f974b5a02c1fd139d7f4e7d75536f0cf60a0?d=retro"}],"changelog":[{"hash":"b291780c200a860e8b6acb86e50f9f124f17597f","date":1734512938000,"email":"929721152@qq.com","author":"王亚坡","message":"初始化提交","commitUrl":"https://github.com/pengzhanbo/vuepress-theme-plume/commit/b291780c200a860e8b6acb86e50f9f124f17597f"}]},"autoDesc":true,"filePathRelative":"notes/theme/blog/guide/功能/公告板.md","bulletin":true}'
	)
